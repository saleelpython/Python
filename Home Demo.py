...
# s0, s1, s2 = set([1,2,3,4,5,3,2,1]), set((1,2,3,4,5,3,2,1)), set({1,2,3,4,5,3,2,1})
# l0, l1, l2 = list([1,2,3,4,5,3,2,1]), list((1,2,3,4,5,3,2,1)), list({1,2,3,4,5,3,2,1})
# t0, t1, t2 = tuple([1,2,3,4,5,3,2,1]), tuple((1,2,3,4,5,3,2,1)), tuple({1,2,3,4,5,3,2,1})
...
# www ="www.google.com"
# dict = {key:www.count(key) for key in www}
# print(dict)
...
# fn(**{"isbn":"HS/200-29SK","title":"mongoDB","price": 25,"qty":4})
...
# df = pandas.read_csv("movie.csv",names=["_id", "release", "color", "director","critic","duration","director_facebook","actor_3_facebook","actor_2_name",	"actor_1_facebook_likes","gross","genres","actor_1_name","movie_title","num_voted_users","cast_total_facebook_likes","actor_3_name","facenumber_in_poster","plot_keywords",	"movie_imdb_link","num_user_for_reviews","language","country","content_rating","budget","title_year","actor_2_facebook_likes","imdb_score","aspect_ratio","movie_facebook_likes","studio"], header=None)
...
#
# print(df["aspect_ratio"].round(3))

# df.sort_values("duration", inplace=True)

# df.sort_values(by=["critic", "director"], ascending=[False, True], inplace=True)

# df.sort_values(by=["director"], ascending = [True], inplace=True, na_position="first")
...
# print(df[(df["duration"] == 100) | (df["duration"] == 150)]["duration"].value_counts())
