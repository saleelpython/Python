...
print( max( [23, 345, 456], default= 1001) )
...
a = pandas.Series(data=login)
b = pandas.Series(data=login.values())
c = pandas.Series(data=login.keys())
...
print( [(key, values) for i in login for key, values in i.items()] )
